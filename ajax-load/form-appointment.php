    ...
    <div class="section-content bg-white p-30">
      <div class="row">
        <div class="col-md-12">
          ...
          <!-- Appointment Form -->
          <form id="popup_appointment_form" name="popup_appointment_form" class="" method="post" action="http://html.kodesolution.live/j/consulting-pro/v3.0/demo/ajax-load/includes/appointment.php">
            <div class="row">
              <div class="col-sm-12">
